...
public class SkipList<E extends Comparable<E>> {
	...
	/** Smallest power of 2 that is greater than the current skiplist size */
	private int maxCap;
	 ...
	 * @return An SLNode array which references the
	 * 		   predecessors of the target at each level.
	 */
	@SuppressWarnings("unchecked")
	...
	public boolean remove(E item) {
		...
		if(pred[0].links != null && pred[0].links[0].data.compareTo(item) != 0) {
			...
			size--;		//don't re-adjust maxCap and level, as we may have does at these levels
