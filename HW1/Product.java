...
public class Product {
	...
	private int inWhichBranch;	/**Branch where it is located*/
	 ...
	 * @param color Prodcut color
	 * @param branchID The branch ID where the product is located
	 */
	public Product(int ID, String type, String model, String color, int branchID) {
		super();
		this.ID = ID;
		this.type = type;
		this.model = model;
		this.color = color;
		this.inWhichBranch = branchID;
	}
	 ...
	 */
	public void setInWhichBranch(int branchID) {
		this.inWhichBranch = branchID; 
	}
